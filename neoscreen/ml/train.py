"""
NeoScreen — Training Script
Transfer learning: MobileNetV3 (ImageNet) → 3-class sclera jaundice classifier
Run on Google Colab (free T4 GPU). Exports neoscreen_v1.tflite (~4MB).

Usage:
    python train.py --data_dir ./dataset --epochs 20 --output neoscreen_v1.tflite
"""
