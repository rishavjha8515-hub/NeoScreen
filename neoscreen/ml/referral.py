"""
NeoScreen — PHC Referral
Step 06: High Risk only → find nearest PHC via GeoPy → send Twilio SMS
No photo transmitted. No PII stored beyond ASHA worker ID and GPS.
"""
