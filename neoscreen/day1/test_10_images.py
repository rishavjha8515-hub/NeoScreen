"""
Day 1 — Task 5 (Evening, 1 hr)
Export verification + smoke-test TF Lite inference on 10 images.
Checks: model size < 5 MB, inference time < 500 ms, output shape correct.
