"""
Day 1 — Task 6 (Evening, 1 hr)
Document accuracy + log every misclassified image with its probabilities.
Identifies systematic failure patterns to guide threshold tuning.

Output:
    day1/reports/misclassification_report.txt
    day1/reports/misclassified_images/  ← copies of wrong predictions
